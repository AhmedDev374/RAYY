#!/usr/bin/env python3
"""
WhatsApp Notifications for رَيّ — RAYY
Handles sending irrigation and plant alerts via WhatsApp using Twilio API
"""
...
Reply STOP to unsubscribe from alerts.
    ...
    def send_digest(self, to_number: str, plant_summary: Dict) -> bool:
        ...
        try:
            message = f"""
💧 *رَيّ — RAYY - Daily Irrigation Digest*
